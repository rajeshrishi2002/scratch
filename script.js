...
const checkBlackFillPercentage = () => {
  ...
  if (blackFillPercentage >= 45) {
    ...
    scratchCardText.textContent ='I am eagerly waiting for this day, and in advance, I wish you all the best as you conquer each milestone and go show the world what you are made of😎';
